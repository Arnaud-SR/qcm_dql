    ...
    <table class="table table-striped">
      ...
      <tbody>
        ...
        foreach ($qcmList as $qcm) {
          ...
          <td><span class='btn btn-info' data-toggle='modal' data-target='#_qcm_modal' data-questions='{$questionsJson}' data-title='{$qcm->title}' data-teacher-name='{$teacherName}'>Détail du QCM</span></td>
